...
<div x-data="rosterReport()" x-init="fetchSessions()">
    <div class="mb-6">
        ...
        <p class="text-sm text-base-content/70 mt-1">Your assigned sessions only. Select a session to view the roster.</p>
    </div>
    ...
    <template x-if="!loading && !error && roster.length > 0">
        <div class="overflow-x-auto card bg-base-100 shadow">
            <table class="table">
                <thead><tr><th>Seat</th><th>Applicant</th><th>Contact</th></tr></thead>
                <tbody>
